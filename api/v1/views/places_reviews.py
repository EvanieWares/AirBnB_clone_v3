...
def get_review(review_id):
    ...
    Returns:
        A Review object, otherwise 404 error
    """
...
def create_review(place_id):
    ...
    Returns:
        The new Review with code 201, otherwise error code 404 or 400
    """
    place = storage.get(Place, place_id)
    if place is None:
        abort(404)
...
def update_review(review_id):
    ...
    Returns:
        The Review object with code 200, otherwise error code 404 or 400
    """
    review = storage.get(Review, review_id)
    if review is None:
        abort(404)
